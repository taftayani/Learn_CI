...
<head>
    ...
    <title>Edit Room-Asset Relation - Asset Assessment System</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-edit"></i> Edit Room-Asset Relation</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="/room-assets/edit/<?= $roomAsset['id'] ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="room_id" name="room_id" required>
                                            ...
                                            <?php foreach ($rooms as $room): ?>
                                                <option value="<?= $room['id'] ?>" <?= $roomAsset['room_id'] == $room['id'] ? 'selected' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="asset_id" name="asset_id" required>
                                            ...
                                            <?php foreach ($assets as $asset): ?>
                                                <option value="<?= $asset['id'] ?>" <?= $roomAsset['asset_id'] == $asset['id'] ? 'selected' : '' ?>>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Relation
                                </button>
                            </div>
                        </form>
                    </div>
