...
<head>
    ...
    <title>Create Room - Asset Assessment System</title>
                                ...
                                <div class="col-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control <?= isset($validation) && $validation->hasError('description') ? 'is-invalid' : '' ?>" 
                                                  ...
                                                  placeholder="Provide additional details about the room, its purpose, capacity, or special features..."><?= old('description') ?></textarea>
